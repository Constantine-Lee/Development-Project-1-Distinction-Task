...
namespace MyGame
{
	public class MWBottomBar
	{
		private Sprite _bottomBarBackground;
		private MWSampleFood [] _sampleFood;
		...
		public MWBottomBar ()
		{
			...
			_sampleFood = new MWSampleFood [3];
			_sampleFood[0] = new MWSampleFood ("BlueCandy.png");
			_sampleFood [1] = new MWSampleFood ("GreenCandy.png");
			_sampleFood [2] = new MWSampleFood ("RedCandy.png");
			//
		}
		...
		public void Draw ()
		{
			...
			foreach (MWSampleFood sampleFood in _sampleFood) {
				sampleFood.Draw ();
			}		
		}
