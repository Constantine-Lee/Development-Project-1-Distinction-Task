...
namespace MyGame
{
	public class MWDiningTable
	{
		...
		public void RegisterSideBar (MWSideBarUpdate sidebarupdate) 
		{
			_sideBar = sidebarupdate;
		}
