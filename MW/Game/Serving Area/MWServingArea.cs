...
namespace MyGame
{
	public class MWServingArea
	{
		private Timer _gameTime;

		private MWEnergyBall _energyPotion;

		private Sprite _sky;
		private Sprite _floor;
		private Sprite _dustbin;

		private MWPlayer _player;

		private TableOfStove [] _tableOfStoves;
		private MWDiningTable [] _diningTables;

		private MWDiningTableManager _diningTableManager;
		...
		public MWServingArea ()
		{
			...
			// 4 Dining Tables
			_diningTables = new MWWoodenTable [4];
			for (int i = 0; i < 4; i++) {
				_diningTables [i] = new MWWoodenTable ();
			}
			_diningTableManager = new MWDiningTableManager (_diningTables);
			//
		...
		public MWDiningTable [] DiningTable {
		...
		public void CheckCollision ()
		{
			...
			foreach (MWDiningTable diningTable in _diningTables) {
