...
namespace MyGame
{
	public class BS_BottomBar
	{
		private Sprite _bottomBarBackground;
		private BS_SampleFood [] _sampleFood;
		private string _selection;
		private List<BS_Stove> _stove;
		...
		public BS_BottomBar ()
		{
			...
			_sampleFood = new BS_SampleFood [3];
			_sampleFood[0] = new BS_SampleFood ("BlueCandy.png");
			_sampleFood [1] = new BS_SampleFood ("GreenCandy.png");
			_sampleFood [2] = new BS_SampleFood ("RedCandy.png");
			//
		}
		...
		public void Draw ()
		{
			...
			foreach (BS_SampleFood sampleFood in _sampleFood) {
				sampleFood.Draw ();
			}		
		}
		...
		public void RegisterStove (BS_Stove[] stoveList)
		{
			foreach (BS_Stove stove in stoveList) {
				_stove.Add (stove);
			}
		}
	}
