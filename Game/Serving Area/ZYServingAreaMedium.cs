...
namespace MyGame
{
    public class ZYServingAreaMedium
    {
        ...
        public ZYServingAreaMedium()
        {
            ...
            //
            SwinGame.LoadBitmapNamed("purpleStorm", "purpleStorm.jpg");
            _sky = SwinGame.CreateSprite(SwinGame.BitmapNamed("purpleStorm"));
            //
